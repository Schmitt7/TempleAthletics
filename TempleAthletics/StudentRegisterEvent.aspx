<%@ Page Title="" Language="C#" MasterPageFile="~/TempleAthletics.Master" AutoEventWireup="true" CodeBehind="StudentRegisterEvent.aspx.cs" Inherits="TempleAthletics.WebForm1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="view">
        ...
        <div class="mb-3">
            <div class="row">
                <div class="col-md-6 button"><a href="StudentHome.aspx"><button class="btn btn-danger d-block w-100" type="button">Register</button></a></div>
            </div>
        </div>
    </div>
</div>
